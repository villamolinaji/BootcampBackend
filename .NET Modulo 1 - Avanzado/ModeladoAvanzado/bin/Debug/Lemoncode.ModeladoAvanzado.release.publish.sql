/*
Deployment script for Lemoncode.ModeladoAvanzado.release
...
GO
:setvar DatabaseName "Lemoncode.ModeladoAvanzado.release"
:setvar DefaultFilePrefix "Lemoncode.ModeladoAvanzado.release"
...
GO
ALTER TABLE [dbo].[SubscripcionUsuario]
...
GO
ALTER TABLE [dbo].[SubscripcionVideo]
    ADD FOREIGN KEY ([SubscripcionId]) REFERENCES [dbo].[Subscripcion] ([SubscripcionId]);
